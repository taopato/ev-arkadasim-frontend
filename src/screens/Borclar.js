...
export default function DebtsScreen({ navigation, route }) {
  ...
  const getStatusColor = (amount) => amount > 0 ? theme.colors.error[600] : theme.colors.neutral[600];
      ...
      <ScrollView style={CommonStyles.content}>
        ...
        <View style={CommonStyles.card}>
          ...
          <View style={styles.netStatusContainer}>
            <Text style={[styles.netAmount, { color: theme.colors.error[600] }]}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <View style={[CommonStyles.buttonContent, { backgroundColor: theme.colors.primary[500] }]}>
